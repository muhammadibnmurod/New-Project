...
const handleLogin = async () => {
  ...
  try {
    ...
    } else if (data.role === 'add_admin') {
      await router.push('/wagon_page')
    } else {
...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-900 text-white px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-6xl mx-auto flex flex-col md:flex-row rounded-xl overflow-hidden shadow-2xl bg-gray-800">
      <!-- Left: Background image -->
      <div class="md:w-1/2 hidden md:flex flex-col justify-between p-8 lg:p-12 bg-cover bg-center"

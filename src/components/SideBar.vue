  ...
  >
    ...
    <nav class="flex flex-col gap-2 flex-1 w-full">
      <div
        ...
        class="relative flex items-center transition-all duration-200 group"
        :class="[
...
// YANGILANGAN QISM: `user` menyusiga ko'proq rollar berildi
const menu = [
  { label: 'vchd_statistics', icon: ChartBarIcon, path: '/vchd', roles: ['moderator'] },
  { label: 'import_taken_out', icon: TruckIcon, path: '/import_taken_out', roles: ['viewer'] },
  { label: 'vagon_user', icon: ChartBarIcon, path: '/vagon_user', roles: ['viewer'] },
  { label: 'planned_taken_out', icon: ChartBarIcon, path: '/planned_taken_out', roles: ['viewer'] },
  { label: 'get_taken_out', icon: ChartBarIcon, path: '/get_taken_out', roles: ['viewer'] },
  { label: 'user', icon: UserIcon, path: '/user', roles: ['superadmin'] },
]
...
// YANGILANGAN QISM: `watchEffect` yordamida `active` state'ini avtomatik yangilash
watchEffect(() => {
